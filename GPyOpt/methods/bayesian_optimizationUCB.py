...
import GPy
from ..core.acquisition import AcquisitionUCB
from ..core.bo import BO

class BayesianOptimizationUCB(BO):
	"""
	Bayesian Optimization using the Upper Confidence Bound acquisition function.
